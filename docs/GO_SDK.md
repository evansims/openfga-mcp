# GO_SDK Documentation

> Compiled from: https://github.com/openfga/go-sdk
> Generated: 2025-08-03 22:13:35 UTC

---


<!-- Source: openfga/go-sdk/README.md -->
...
------------ | ------------- | ------------- | -------------
*OpenFgaApi* | [**BatchCheck**](https://github.com/openfga/go-sdk/blob/main/docs/OpenFgaApi.md#batchcheck) | **Post** /stores/{store_id}/batch-check | Send a list of &#x60;check&#x60; operations in a single request
*OpenFgaApi* | [**Check**](https://github.com/openfga/go-sdk/blob/main/docs/OpenFgaApi.md#check) | **Post** /stores/{store_id}/check | Check whether a user is authorized to access an object
*OpenFgaApi* | [**CreateStore**](https://github.com/openfga/go-sdk/blob/main/docs/OpenFgaApi.md#createstore) | **Post** /stores | Create a store
*OpenFgaApi* | [**DeleteStore**](https://github.com/openfga/go-sdk/blob/main/docs/OpenFgaApi.md#deletestore) | **Delete** /stores/{store_id} | Delete a store
*OpenFgaApi* | [**Expand**](https://github.com/openfga/go-sdk/blob/main/docs/OpenFgaApi.md#expand) | **Post** /stores/{store_id}/expand | Expand all relationships in userset tree format, and following userset rewrite rules.  Useful to reason about and debug a certain relationship
*OpenFgaApi* | [**GetStore**](https://github.com/openfga/go-sdk/blob/main/docs/OpenFgaApi.md#getstore) | **Get** /stores/{store_id} | Get a store
*OpenFgaApi* | [**ListObjects**](https://github.com/openfga/go-sdk/blob/main/docs/OpenFgaApi.md#listobjects) | **Post** /stores/{store_id}/list-objects | List all objects of the given type that the user has a relation with
*OpenFgaApi* | [**ListStores**](https://github.com/openfga/go-sdk/blob/main/docs/OpenFgaApi.md#liststores) | **Get** /stores | List all stores
*OpenFgaApi* | [**ListUsers**](https://github.com/openfga/go-sdk/blob/main/docs/OpenFgaApi.md#listusers) | **Post** /stores/{store_id}/list-users | List the users matching the provided filter who have a certain relation to a particular type.
*OpenFgaApi* | [**Read**](https://github.com/openfga/go-sdk/blob/main/docs/OpenFgaApi.md#read) | **Post** /stores/{store_id}/read | Get tuples from the store that matches a query, without following userset rewrite rules
*OpenFgaApi* | [**ReadAssertions**](https://github.com/openfga/go-sdk/blob/main/docs/OpenFgaApi.md#readassertions) | **Get** /stores/{store_id}/assertions/{authorization_model_id} | Read assertions for an authorization model ID
*OpenFgaApi* | [**ReadAuthorizationModel**](https://github.com/openfga/go-sdk/blob/main/docs/OpenFgaApi.md#readauthorizationmodel) | **Get** /stores/{store_id}/authorization-models/{id} | Return a particular version of an authorization model
*OpenFgaApi* | [**ReadAuthorizationModels**](https://github.com/openfga/go-sdk/blob/main/docs/OpenFgaApi.md#readauthorizationmodels) | **Get** /stores/{store_id}/authorization-models | Return all the authorization models for a particular store
*OpenFgaApi* | [**ReadChanges**](https://github.com/openfga/go-sdk/blob/main/docs/OpenFgaApi.md#readchanges) | **Get** /stores/{store_id}/changes | Return a list of all the tuple changes
*OpenFgaApi* | [**Write**](https://github.com/openfga/go-sdk/blob/main/docs/OpenFgaApi.md#write) | **Post** /stores/{store_id}/write | Add or delete tuples from the store
*OpenFgaApi* | [**WriteAssertions**](https://github.com/openfga/go-sdk/blob/main/docs/OpenFgaApi.md#writeassertions) | **Put** /stores/{store_id}/assertions/{authorization_model_id} | Upsert assertions for an authorization model ID
*OpenFgaApi* | [**WriteAuthorizationModel**](https://github.com/openfga/go-sdk/blob/main/docs/OpenFgaApi.md#writeauthorizationmodel) | **Post** /stores/{store_id}/authorization-models | Create a new authorization model


#### Models

 - [AbortedMessageResponse](https://github.com/openfga/go-sdk/blob/main/docs/AbortedMessageResponse.md)
 - [Any](https://github.com/openfga/go-sdk/blob/main/docs/Any.md)
 - [Assertion](https://github.com/openfga/go-sdk/blob/main/docs/Assertion.md)
 - [AssertionTupleKey](https://github.com/openfga/go-sdk/blob/main/docs/AssertionTupleKey.md)
 - [AuthErrorCode](https://github.com/openfga/go-sdk/blob/main/docs/AuthErrorCode.md)
 - [AuthorizationModel](https://github.com/openfga/go-sdk/blob/main/docs/AuthorizationModel.md)
 - [BatchCheckItem](https://github.com/openfga/go-sdk/blob/main/docs/BatchCheckItem.md)
 - [BatchCheckRequest](https://github.com/openfga/go-sdk/blob/main/docs/BatchCheckRequest.md)
 - [BatchCheckResponse](https://github.com/openfga/go-sdk/blob/main/docs/BatchCheckResponse.md)
 - [BatchCheckSingleResult](https://github.com/openfga/go-sdk/blob/main/docs/BatchCheckSingleResult.md)
 - [CheckError](https://github.com/openfga/go-sdk/blob/main/docs/CheckError.md)
 - [CheckRequest](https://github.com/openfga/go-sdk/blob/main/docs/CheckRequest.md)
 - [CheckRequestTupleKey](https://github.com/openfga/go-sdk/blob/main/docs/CheckRequestTupleKey.md)
 - [CheckResponse](https://github.com/openfga/go-sdk/blob/main/docs/CheckResponse.md)
 - [Computed](https://github.com/openfga/go-sdk/blob/main/docs/Computed.md)
 - [Condition](https://github.com/openfga/go-sdk/blob/main/docs/Condition.md)
 - [ConditionMetadata](https://github.com/openfga/go-sdk/blob/main/docs/ConditionMetadata.md)
 - [ConditionParamTypeRef](https://github.com/openfga/go-sdk/blob/main/docs/ConditionParamTypeRef.md)
 - [ConsistencyPreference](https://github.com/openfga/go-sdk/blob/main/docs/ConsistencyPreference.md)
 - [ContextualTupleKeys](https://github.com/openfga/go-sdk/blob/main/docs/ContextualTupleKeys.md)
 - [CreateStoreRequest](https://github.com/openfga/go-sdk/blob/main/docs/CreateStoreRequest.md)
 - [CreateStoreResponse](https://github.com/openfga/go-sdk/blob/main/docs/CreateStoreResponse.md)
 - [Difference](https://github.com/openfga/go-sdk/blob/main/docs/Difference.md)
 - [ErrorCode](https://github.com/openfga/go-sdk/blob/main/docs/ErrorCode.md)
 - [ExpandRequest](https://github.com/openfga/go-sdk/blob/main/docs/ExpandRequest.md)
 - [ExpandRequestTupleKey](https://github.com/openfga/go-sdk/blob/main/docs/ExpandRequestTupleKey.md)
 - [ExpandResponse](https://github.com/openfga/go-sdk/blob/main/docs/ExpandResponse.md)
 - [FgaObject](https://github.com/openfga/go-sdk/blob/main/docs/FgaObject.md)
 - [ForbiddenResponse](https://github.com/openfga/go-sdk/blob/main/docs/ForbiddenResponse.md)
 - [GetStoreResponse](https://github.com/openfga/go-sdk/blob/main/docs/GetStoreResponse.md)
 - [InternalErrorCode](https://github.com/openfga/go-sdk/blob/main/docs/InternalErrorCode.md)
 - [InternalErrorMessageResponse](https://github.com/openfga/go-sdk/blob/main/docs/InternalErrorMessageResponse.md)
 - [Leaf](https://github.com/openfga/go-sdk/blob/main/docs/Leaf.md)
 - [ListObjectsRequest](https://github.com/openfga/go-sdk/blob/main/docs/ListObjectsRequest.md)
 - [ListObjectsResponse](https://github.com/openfga/go-sdk/blob/main/docs/ListObjectsResponse.md)
 - [ListStoresResponse](https://github.com/openfga/go-sdk/blob/main/docs/ListStoresResponse.md)
 - [ListUsersRequest](https://github.com/openfga/go-sdk/blob/main/docs/ListUsersRequest.md)
 - [ListUsersResponse](https://github.com/openfga/go-sdk/blob/main/docs/ListUsersResponse.md)
 - [Metadata](https://github.com/openfga/go-sdk/blob/main/docs/Metadata.md)
 - [Node](https://github.com/openfga/go-sdk/blob/main/docs/Node.md)
 - [Nodes](https://github.com/openfga/go-sdk/blob/main/docs/Nodes.md)
 - [NotFoundErrorCode](https://github.com/openfga/go-sdk/blob/main/docs/NotFoundErrorCode.md)
 - [NullValue](https://github.com/openfga/go-sdk/blob/main/docs/NullValue.md)
 - [ObjectRelation](https://github.com/openfga/go-sdk/blob/main/docs/ObjectRelation.md)
 - [PathUnknownErrorMessageResponse](https://github.com/openfga/go-sdk/blob/main/docs/PathUnknownErrorMessageResponse.md)
 - [ReadAssertionsResponse](https://github.com/openfga/go-sdk/blob/main/docs/ReadAssertionsResponse.md)
 - [ReadAuthorizationModelResponse](https://github.com/openfga/go-sdk/blob/main/docs/ReadAuthorizationModelResponse.md)
 - [ReadAuthorizationModelsResponse](https://github.com/openfga/go-sdk/blob/main/docs/ReadAuthorizationModelsResponse.md)
 - [ReadChangesResponse](https://github.com/openfga/go-sdk/blob/main/docs/ReadChangesResponse.md)
 - [ReadRequest](https://github.com/openfga/go-sdk/blob/main/docs/ReadRequest.md)
 - [ReadRequestTupleKey](https://github.com/openfga/go-sdk/blob/main/docs/ReadRequestTupleKey.md)
 - [ReadResponse](https://github.com/openfga/go-sdk/blob/main/docs/ReadResponse.md)
 - [RelationMetadata](https://github.com/openfga/go-sdk/blob/main/docs/RelationMetadata.md)
 - [RelationReference](https://github.com/openfga/go-sdk/blob/main/docs/RelationReference.md)
 - [RelationshipCondition](https://github.com/openfga/go-sdk/blob/main/docs/RelationshipCondition.md)
 - [SourceInfo](https://github.com/openfga/go-sdk/blob/main/docs/SourceInfo.md)
 - [Status](https://github.com/openfga/go-sdk/blob/main/docs/Status.md)
 - [Store](https://github.com/openfga/go-sdk/blob/main/docs/Store.md)
 - [Tuple](https://github.com/openfga/go-sdk/blob/main/docs/Tuple.md)
 - [TupleChange](https://github.com/openfga/go-sdk/blob/main/docs/TupleChange.md)
 - [TupleKey](https://github.com/openfga/go-sdk/blob/main/docs/TupleKey.md)
 - [TupleKeyWithoutCondition](https://github.com/openfga/go-sdk/blob/main/docs/TupleKeyWithoutCondition.md)
 - [TupleOperation](https://github.com/openfga/go-sdk/blob/main/docs/TupleOperation.md)
 - [TupleToUserset](https://github.com/openfga/go-sdk/blob/main/docs/TupleToUserset.md)
 - [TypeDefinition](https://github.com/openfga/go-sdk/blob/main/docs/TypeDefinition.md)
 - [TypeName](https://github.com/openfga/go-sdk/blob/main/docs/TypeName.md)
 - [TypedWildcard](https://github.com/openfga/go-sdk/blob/main/docs/TypedWildcard.md)
 - [UnauthenticatedResponse](https://github.com/openfga/go-sdk/blob/main/docs/UnauthenticatedResponse.md)
 - [UnprocessableContentErrorCode](https://github.com/openfga/go-sdk/blob/main/docs/UnprocessableContentErrorCode.md)
 - [UnprocessableContentMessageResponse](https://github.com/openfga/go-sdk/blob/main/docs/UnprocessableContentMessageResponse.md)
 - [User](https://github.com/openfga/go-sdk/blob/main/docs/User.md)
 - [UserTypeFilter](https://github.com/openfga/go-sdk/blob/main/docs/UserTypeFilter.md)
 - [Users](https://github.com/openfga/go-sdk/blob/main/docs/Users.md)
 - [Userset](https://github.com/openfga/go-sdk/blob/main/docs/Userset.md)
 - [UsersetTree](https://github.com/openfga/go-sdk/blob/main/docs/UsersetTree.md)
 - [UsersetTreeDifference](https://github.com/openfga/go-sdk/blob/main/docs/UsersetTreeDifference.md)
 - [UsersetTreeTupleToUserset](https://github.com/openfga/go-sdk/blob/main/docs/UsersetTreeTupleToUserset.md)
 - [UsersetUser](https://github.com/openfga/go-sdk/blob/main/docs/UsersetUser.md)
 - [Usersets](https://github.com/openfga/go-sdk/blob/main/docs/Usersets.md)
 - [ValidationErrorMessageResponse](https://github.com/openfga/go-sdk/blob/main/docs/ValidationErrorMessageResponse.md)
 - [WriteAssertionsRequest](https://github.com/openfga/go-sdk/blob/main/docs/WriteAssertionsRequest.md)
 - [WriteAuthorizationModelRequest](https://github.com/openfga/go-sdk/blob/main/docs/WriteAuthorizationModelRequest.md)
 - [WriteAuthorizationModelResponse](https://github.com/openfga/go-sdk/blob/main/docs/WriteAuthorizationModelResponse.md)
 - [WriteRequest](https://github.com/openfga/go-sdk/blob/main/docs/WriteRequest.md)
 - [WriteRequestDeletes](https://github.com/openfga/go-sdk/blob/main/docs/WriteRequestDeletes.md)
 - [WriteRequestWrites](https://github.com/openfga/go-sdk/blob/main/docs/WriteRequestWrites.md)
...
This repo bundles some code from the [golang.org/x/oauth2](https://pkg.go.dev/golang.org/x/oauth2) package. You can find the code [here](https://github.com/openfga/go-sdk/blob/main/./oauth2) and corresponding [BSD-3 License](https://github.com/openfga/go-sdk/blob/main/./oauth2/LICENSE).


<!-- End of openfga/go-sdk/README.md -->
